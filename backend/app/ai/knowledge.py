...
RESOURCE_EXTRAS: tuple[Resource, ...] = (
    ...
    Resource(id='guide-limit', kind='资料', topic='极限与连续',
             title='第一章导览：极限与连续的复习路线',
             summary='建议顺序：极限定义 → 四则运算与两个重要极限 → 无穷小比较 → 连续与间断点分类 → 闭区间性质。',
             point_id='limit-definition', source='待课程资料复核后补充正式版本'),
    Resource(id='guide-derivative', kind='资料', topic='导数与微分',
             title='第二章导览：导数与微分的复习路线',
             summary='建议顺序：导数定义与可导性 → 求导法则与高阶导数 → 微分 → 单调性与极值 → 凹凸与最值应用。',
             point_id='derivative-definition', source='待课程资料复核后补充正式版本'),
    Resource(id='guide-integral', kind='资料', topic='一元函数积分学',
             title='第五章导览：一元积分的复习路线',
             summary='建议顺序：原函数与不定积分 → 基本积分表 → 定积分定义 → 牛顿-莱布尼茨公式 → 换元与分部积分 → 定积分应用。',
             point_id='integral-definite', source='待课程资料复核后补充正式版本'),
    Resource(id='guide-series', kind='资料', topic='无穷级数',
             title='第十二章导览：无穷级数的复习路线',
             summary='建议顺序：部分和与收敛定义 → 收敛必要条件 → 正项级数判别法 → 交错级数与绝对收敛 → 幂级数收敛域。',
             point_id='series-convergence', source='待课程资料复核后补充正式版本'),
    Resource(id='flow-limit-strategy', kind='资料', topic='极限与连续',
             title='极限计算思路图（先代入、再变形、后性态）',
             summary='先尝试直接代入；遇 0/0 或 ∞/∞ 再考虑约分、通分、有理化、等价无穷小替换或洛必达法则；分母趋零时再看左右极限。',
             point_id='limit-techniques', source='待课程资料复核后补充正式版本'),
    Resource(id='flow-integral-choice', kind='资料', topic='一元函数积分学',
             title='积分方法选择表',
             summary='含复合结构优先凑微分；含根式考虑三角代换；乘积形式（对数、反三角、幂函数）用分部积分；有理分式先部分分式分解。',
             point_id='integral-techniques', source='待课程资料复核后补充正式版本'),
)
